...
image1 = Image.open("C:\\Users\shish\Downloads\heyaaa.jpg")
...
thelabel_0=Label(window,text="REGISTRATION",width=18,height=2,font="ariel 30 bold",bg="powder blue")
...
def insert1():
    ...
    tt1=(in1,in2,in4,in5,in7,in8,in9,in3,in6)
...
def work():
    if metext19.get()==metext20.get():
        ...
        tkinter.messagebox.showinfo("your passwords didn't match","check again")

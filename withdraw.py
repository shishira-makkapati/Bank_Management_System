...
image1 = Image.open("C:\\Users\shish\Downloads\hey (1).jpg")
...
image1 = Image.open("C:\\Users\shish\Downloads\hello.jpg")
...
def insert1():
    ...
    tt1=(acc_num,"W",in1,today,current_time)
...
thelabel_1=Label(window,text="ENTER AMOUNT TO WITHDRAW",font="ariel 13 bold",bg="powder blue")
